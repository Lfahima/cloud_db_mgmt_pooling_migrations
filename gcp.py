...
from sqlalchemy import create_engine, inspect, Column, Integer, String, Date, ForeignKey, DateTime
...
engine = create_engine("mysql+mysqlconnector://root:yourpassword!@34.67.92.247/fahima")
